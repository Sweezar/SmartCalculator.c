...
public:
    ...
    QRadioButton *radioButton_default_2;
...
"padding: 15px"));
        ...
        operation_button_clear->setGeometry(QRect(10, 180, 81, 61));
        ...
        operation_button_remove->setGeometry(QRect(90, 180, 81, 61));
        ...
        operation_button_dot->setGeometry(QRect(10, 420, 81, 61));
        ...
        operation_button_mult->setGeometry(QRect(250, 300, 81, 61));
        ...
        operation_button_sum->setGeometry(QRect(250, 420, 81, 61));
        ...
        operation_button_sub->setGeometry(QRect(250, 360, 81, 61));
        ...
        operation_button_div->setGeometry(QRect(250, 240, 81, 61));
        ...
        operation_button_sin->setGeometry(QRect(330, 180, 81, 61));
        ...
        operation_button_lg->setGeometry(QRect(410, 420, 81, 61));
        ...
        operation_button_ln->setGeometry(QRect(330, 420, 81, 61));
        ...
        operation_button_cos->setGeometry(QRect(330, 240, 81, 61));
        ...
        operation_button_tan->setGeometry(QRect(330, 300, 81, 61));
        ...
        operation_button_left_bracket->setGeometry(QRect(170, 180, 81, 61));
        ...
        operation_button_right_bracket->setGeometry(QRect(250, 180, 81, 61));
        ...
        operation_button_atan->setGeometry(QRect(410, 300, 81, 61));
        ...
        operation_button_sqrt->setGeometry(QRect(330, 360, 81, 61));
        ...
        operation_button_pow->setGeometry(QRect(410, 120, 81, 61));
        ...
        operation_button_mod->setGeometry(QRect(410, 360, 81, 61));
        ...
        operation_button_asin->setGeometry(QRect(410, 180, 81, 61));
        ...
        operation_button_acos->setGeometry(QRect(410, 240, 81, 61));
        ...
        radioButton_default->setGeometry(QRect(60, 490, 111, 61));
...
"font-size: 16px;"));
        ...
        radioButton_credit->setGeometry(QRect(280, 490, 101, 61));
...
"font-size: 16px;"));
        ...
        radioButton_deposit->setGeometry(QRect(380, 490, 111, 61));
...
"font-size: 16px;"));
        ...
        operation_button_result->setGeometry(QRect(170, 420, 81, 61));
        operation_button_result->setStyleSheet(QString::fromUtf8(""));
        radioButton_default_2 = new QRadioButton(centralwidget);
        radioButton_default_2->setObjectName(QString::fromUtf8("radioButton_default_2"));
        radioButton_default_2->setGeometry(QRect(170, 490, 111, 61));
        radioButton_default_2->setStyleSheet(QString::fromUtf8("padding-left: 5px;\n"
"font-size: 16px;"));
        operation_button_x = new QPushButton(centralwidget);
        operation_button_x->setObjectName(QString::fromUtf8("operation_button_x"));
        operation_button_x->setGeometry(QRect(10, 120, 81, 61));
        operation_button_x->setStyleSheet(QString::fromUtf8(""));
        operation_button_x->setIconSize(QSize(16, 16));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(97, 125, 71, 51));
        label_2->setAlignment(Qt::AlignCenter);
        x_show = new QDoubleSpinBox(centralwidget);
        x_show->setObjectName(QString::fromUtf8("x_show"));
        x_show->setGeometry(QRect(171, 125, 231, 51));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        radioButton_default_2->setText(QCoreApplication::translate("MainWindow", "graph", nullptr));
